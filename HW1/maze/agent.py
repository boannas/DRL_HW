...
class Agent(object):
    def __init__(self, states, alpha=0.15, ramdom_factor=0.2):
        self.state_history = [((0,0), 0)] # state, reward
        self.alpha = alpha
        self.random_factor = ramdom_factor
        
        # Start the reward table
        self.G = {}
    ...
    def choose_action(self, state, allowed_moves):
        next_move = None
        n = np.random.random()
        maxG = -10e15           # small random number
